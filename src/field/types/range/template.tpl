...
<div class="field__filter">
  <span class="field-range__from">From</span>
  <input class="js-from field-range__input" type="text" value="<%= field.getFromText() %>" title="Set minimum <%= field.label %>"/>
  <span class="field-range__to">To</span>
  <input class="js-to field-range__input" type="text" value="<%= field.getToText()  %>" title="Set maximum <%= field.label %>"/>
